                        ...
                        <article id="special<?php echo $book['bookID'];?>" class="boc-product-box">
                            ...
                            <div class="product-bottom">
                                ...
                                <div class="boc-2-cols boc-center-both boc-grid-gap-tiny">
                                    <a href="javascript:void(0);" onclick="wishlistAction('remove',<?php echo $book['bookID'];?><?php if(isset($_SESSION["current_user"])){ echo ',true'; } ?>)"><span><i class="fas fa-heart"></i>Remove from Wishlist</span></a>
