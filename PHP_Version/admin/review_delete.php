...
*/
    ...
    <title>Barry's Bargain Books:: Delete a Review</title>
    ...
    <main id="main">
    	<section class="breadcrumb">
            <div id="breadcrumb" class="boc-grid-container">
                ...
                <span class="separator">></span>
                <span class="current">Delete a Review</span>
            </div>
        </section>
<?php 
...
/**********************    delete the selected review    **********************/
	try {
	    // prepare and bind
	    $stmt = $connection->prepare("DELETE FROM reviews WHERE reviewID=:id;");
		...
		if($return_value) {   
            echo "<h2 class='boc-center'><i class='far fa-check-circle green'></i> Review Deleted</h2>";
