...
*/
    ...
    <title>Barry's Bargain Books:: Delete a Carousel Image</title>
    ...
    <main id="main">
    	<section class="breadcrumb">
            <div id="breadcrumb" class="boc-grid-container">
                ...
                <span class="separator">></span>
                <span class="current">Delete a Carousel Image</span>
            </div>
        </section>
<?php 
...
if (isset($_GET['id'])) { 
/**********************    delete the selected carousel    **********************/
	try {
	    // prepare and bind
	    $stmt = $connection->prepare("DELETE FROM carousel WHERE carouselID=:id;");
		...
		if($return_value) {   
            echo "<h2 class='boc-center'><i class='far fa-check-circle green'></i> Carousel Image Deleted</h2>";
