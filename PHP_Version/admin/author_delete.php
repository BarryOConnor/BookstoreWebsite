...
*/
    ...
    <title>Barry's Bargain Books:: Delete an Author</title>
    ...
    <main id="main">
    	<section class="breadcrumb">
            <div id="breadcrumb" class="boc-grid-container">
                ...
                <span class="separator">></span>
                <span class="current">Delete an Author</span>
            </div>
        </section>
<?php 
...
/**********************    delete the selected author    **********************/
	try {
	    // prepare and bind
	    $stmt = $connection->prepare("DELETE FROM authors WHERE authorID=:id;");
		...
		if($return_value) {   
            echo "<h2 class='boc-center'><i class='far fa-check-circle green'></i> Author Deleted</h2>";
...
/**********************    no id specified display an error    **********************/
 ...
 echo "<p class='boc-center'>You will be returned to the Author Index in 3 seconds or you can <a href='authors.php'>return to the Author Index index now</a></p>";
 header( "refresh:3;url=authors.php" );
} 
 ?>
    </main>
