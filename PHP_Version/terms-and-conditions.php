...
This site uses fontawesome (https://fontawesome.com) for icons
    ...
    <title>Barry's Bargain Books :: Terms & Conditions</title>
...
<body>
    ...
    <main id="main">
        <section id="plain-text" class="boc-white-bg">
            ...
            <h1 class="boc-mblue-bg boc-pad-1 boc-center">Terms &amp; Conditions</h1>
            ...
            <div class="boc-grid-container boc-pad-2">
                <p>These terms and conditions outline the rules and regulations for the use of Barry's Bargain Books's Website.</p>
                <p>Barry's Bargain Books is located at:</p>
                <address>
                    13 Anytown Street,
                    Any Town
                    Any County
                ...
                <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Barry's Bargain Books's website if you do not accept all of the terms and conditions stated on this page.</p>
                ...
                <h2>Cookies</h2>
                <p>We employ the use of cookies. By using Barry's Bargain Books's website you consent to the use of cookies in accordance with Barry's Bargain Books's privacy policy.</p>
                ...
                <h2>License</h2>
                <p>Unless otherwise stated, Barry's Bargain Books and/or it's licensors own the intellectual property rights for all material on Barry's Bargain Books. All intellectual property rights are reserved. You may view and/or print pages from http://www.barrysbargainbooks.com for your own personal use subject to restrictions set in these terms and conditions.</p>
                <p>You must not:</p>
                <ul>
                    <li>Republish material from http://www.barrysbargainbooks.com</li>
                    <li>Sell, rent or sub-license material from http://www.barrysbargainbooks.com</li>
                    <li>Reproduce, duplicate or copy material from http://www.barrysbargainbooks.com</li>
                </ul>
                <p>Redistribute content from Barry's Bargain Books (unless content is specifically made for redistribution).</p>
                <h2>User Comments</h2>
                <ul>
                    <li>This Agreement shall begin on the date hereof.</li>
                    <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. Barry's Bargain Books does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions ofBarry's Bargain Books, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws Barry's Bargain Booksshall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
                    </li>
                    <li>Barry's Bargain Booksreserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
                    ...
                    <li>You hereby grant to <strong>Barry's Bargain Books</strong> a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
                </ul>
                ...
                <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect unfavorably on us or our accredited businesses (for example, trade associations or other organizations representing inherently suspect types of business, such as work-at-home opportunities, shall not be allowed to link); (b)the organization does not have an unsatisfactory record with us; (c) the benefit to us from the visibility associated with the hyperlink outweighs the absence of Barry's Bargain Books; and (d) where the link is in the context of general resource information or is otherwise consistent with editorial content in a newsletter or similar product furthering the mission of the organization.</p>

                <p>These organizations may link to our home page, to publications or to other Web site information so long as the link: (a) is not in any way misleading; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and it products or services; and (c) fits within the context of the linking party's site.
                </p>

                <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to <a href="mailto:info@barrysbargainbooks.com" title="send an email to info@barrysbargainbooks.com">info@barrysbargainbooks.com</a>. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
                ...
                <p>No use of Barry's Bargain Books's logo or other artwork will be allowed for linking absent a trademark license agreement.
                </p>
                <h2>Iframes</h2>
                ...
                <p>This Terms and conditions page was created at <a href="https://termsandconditionstemplate.com">termsandconditionstemplate.com</a> generator. If you have any queries regarding any of our terms, please contact us.</p> 
