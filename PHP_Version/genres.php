...
- This page uses XML code and the getXMLContent function which are adapted from the XPath tutorials 
  available on W3CSchools at https://www.w3schools.com/xml/xpath_examples.asp
    ...
    <title>Barry's Bargain Books :: Genres</title>
...
<body>
    ...
    <main id="main">
        <section class="boc-white-bg">
            ...
            <h1 class="boc-mblue-bg boc-pad-1 boc-center">Genres</h1>
            ...
            <div id="authors" class="boc-pad-2">
                ...
                try {
                    ...
                    $stmt = $connection->prepare("SELECT genreID, name, description, image, image_alt FROM genres WHERE is_active=1 ORDER BY name ASC;");
                    ...
                    while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                        ...
                        <article id="<?php echo $result['name'];?>" class="boc-author-box boc-grid-container boc-grid-gap boc-1-3-cols">
                            <div class="image-col">
                                <a href="genre.php?id=<?php echo $result['genreID'];?>"><img src="<?php echo $result['image'];?>" alt="<?php echo $result['image_alt'];?>"></a>
                            </div>
